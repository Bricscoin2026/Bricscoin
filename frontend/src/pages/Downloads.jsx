          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 p-4 bg-primary/10 border border-primary/20 rounded-sm">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="font-bold text-primary">BricsCoin Core v1.3 (Recommended)</h4>
              </div>
              ...
              <ol className="text-sm text-muted-foreground space-y-2 list-decimal list-inside">
                <li>Download <code className="bg-white/10 px-1 rounded">BricsCoin-Core-v1.3.tar.gz</code></li>
                <li>Extract: <code className="bg-white/10 px-1 rounded">tar -xzf BricsCoin-Core-v1.3.tar.gz</code></li>
